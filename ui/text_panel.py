...
class FontFormatPanel(Widget):
    ...
    def __init__(self, app: QApplication, *args, **kwargs) -> None:
        ...
        self.familybox.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        ...
        self.stylebox.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        ...
        hl1 = QHBoxLayout()
        hl1.addWidget(self.familybox, 5)
        hl1.addWidget(self.stylebox, 3)
        hl1.addWidget(self.fontsizebox, 0)
        hl1.setSpacing(4)
